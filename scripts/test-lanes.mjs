export const dotnetProjects = Object.freeze([
  Object.freeze({
    id: 'core',
    path: 'backend/tests/AgentOrchestrator.CodeQuality.Tests/AgentOrchestrator.CodeQuality.Tests.csproj',
  }),
  Object.freeze({
    id: 'api',
    path: 'backend/tests/QualityStudio.Api.Tests/QualityStudio.Api.Tests.csproj',
  }),
]);
