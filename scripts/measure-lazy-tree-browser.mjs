...
try {
  ...
  try {
    ...
    await page.screenshot({ path: resolve(resultsRoot, 'tree-transport-before-dark.png'), fullPage: true });
    await page.getByRole('button', { name: 'Switch to light theme' }).click();
    await page.waitForFunction(() => document.documentElement.dataset['theme'] === 'light');
    await page.screenshot({ path: resolve(resultsRoot, 'tree-transport-before.png'), fullPage: true });
    ...
    const result = {
      ...
      productWorktreeDirty: execFileSync('git', ['status', '--porcelain'],
        { cwd: repositoryRoot, encoding: 'utf8' }).trim().length > 0,
      target: {
      ...
      screenshots: [
        'tree-transport-before.png',
        'tree-transport-before-dark.png',
        'tree-transport-after.png',
        'tree-transport-after-dark.png',
      ],
    };
