...
try {
  ...
  const restoredSwitch = await measureSwitch(restoredProcess.url, 'v2');
  ...
  const restoredWarmSwitch = await measureSwitch(restoredProcess.url, 'v2');
  const restoredLegacySwitch = await measureSwitch(restoredProcess.url);
