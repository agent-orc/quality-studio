...
2. Review and update project allowlists at the external data-root path `.quality/security/gitleaks.toml`.
...
- Baselines and allowlists are project-owned in the external data root so accepted placeholders stay auditable.
