...
| Root request, 10 warm samples | 328.59 ms median / 756.18 ms p95 | 33.76 ms / 50.35 ms | -89.73% median |
| Project plus root, 10 warm samples | 365.97 ms median / 911.72 ms p95 | 30.45 ms / 49.98 ms | -91.68% median |
| Real-browser large-repository switch, 5 samples | 1,012.4 ms median / 1,425.2 ms p95 (QS-59) | 23.4 ms / 54.4 ms | all v2 samples pass 500 ms |
