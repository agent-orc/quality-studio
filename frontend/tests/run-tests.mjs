...
import { findBrowserBinary } from './browser-resolver.mjs';
...
if (!chromeBin) {
  console.error(
    'Unable to locate a Chrome-compatible browser binary for the Angular test runner. ' +
      'Install Chrome/Chromium, set CHROME_BIN, or run "npm run browser:install" to provision the pinned Playwright Chromium.',
  );
  process.exit(1);
}
