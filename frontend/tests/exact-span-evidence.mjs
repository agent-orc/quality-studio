  ...
  findings: [
    {
      ...
      locations: [{ path: 'src/QualityStudio.Api/Program.cs', range: { start: { line: 8, column: 5 }, end: { line: 8, column: 17 } } }],
    },
    {
      ...
      locations: [{ path: 'src/QualityStudio.Api/Program.cs', range: { start: { line: 8, column: 13 }, end: { line: 8, column: 25 } } }],
    },
  ],
};
