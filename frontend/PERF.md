...
- Production bundle budgets are enforced at 350 KB warning / 490 KB error initially and 10/12 KB per component stylesheet. The attack matrix is a deferred 17 KB lazy chunk and is not paid on the editor's first-content path. QS-84 raised the initial error budget from 480 KB to 490 KB: highlighted finding spans and the finding ignore list added 6.16 KB to the initial bundle, measured at 486.16 KB against the previous 480 KB ceiling.
