...
| Agent Studio lazy-root switch | < 500 ms click-to-usable | 26.9 ms median / 71.3 ms p95 | Pass |
| Lazy child expansion | < 100 ms request-to-paint | 44.3 ms | Pass |
| Cached tree toggle | < 50 ms scripting-to-paint | 3.5 ms median / 14.8 ms p95 | Pass |
...
usable in 11.4–71.3 ms (26.9 ms median). The first project expansion fetched
ten children and painted in 44.3 ms; six later cached expand/collapse actions
measured 1.5–14.8 ms. Child requests carry the immutable root snapshot ETag,
