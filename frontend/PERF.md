...
| Agent Studio lazy-root switch | < 500 ms click-to-usable | 36.6 ms median / 168.8 ms p95 | Pass |
| Lazy child expansion | < 100 ms request-to-paint | 33.1 ms | Pass |
| Cached tree toggle | < 50 ms scripting-to-paint | 3.3 ms median / 10.9 ms p95 | Pass |
...
usable in 33.1–168.8 ms (36.6 ms median). The first project expansion fetched
ten children and painted in 33.1 ms; six later cached expand/collapse actions
measured 1.5–10.9 ms. The explorer keeps keyboard and virtualized-row behavior,
...
initial bundle fell from 478.30 kB to 436.14 kB (42.16 kB / 8.82%), passing the
