...
export interface ReviewHistorySummary {
  ...
  kind: ReviewKind | null; outcome: ReviewRunState | 'legacy-usage-only' | null; complete: boolean | null; attempt: number | null;
  ...
  model?: string | null; spend?: { tokens: TokenUsage; cost: number | null; currency: string | null; priceStatus: string } | null;
