...
export interface ArchivedRunRecord {
  ...
  configuration: { model: string | null; thinkingLevel: string | null; cliType: string; force: boolean; tokenCap: number | null; costCap: number | null; estimate: ReviewEstimate | null };
