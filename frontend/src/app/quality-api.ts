...
export interface ReviewRunError { code: string; message: string; operation: string | null; retryable: boolean; reviewerRunId: string | null; diagnosticsPath: string | null; cliPath: string | null; }
