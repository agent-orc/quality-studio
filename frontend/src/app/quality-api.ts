...
export class QualityApi {
  ...
  runReportViewUrl(id: string): string {
    return `${this.repositoryApiBase()}/review/runs/${encodeURIComponent(id)}/report/view`;
  }
