...
import { FindingSeverity, FindingState, FindingSuppressionRule, HandoverRequest, ReviewFinding, ReviewKind, ReviewThread, ScopeRuleView } from '../../../core/models/contracts';
...
@Component({
  ...
  styleUrls: ['./review-panel.css', './ignore-list.css', './finding-detail.css', './scope-manager.css'],
