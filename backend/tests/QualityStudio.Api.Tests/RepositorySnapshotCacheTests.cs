...
public sealed class RepositorySnapshotCacheTests : IAsyncLifetime
{
    ...
    {
        // Zero fingerprint TTL: this test is about the invalidation rule, not about the window in
        // which one Git fingerprint is deliberately reused.
        var hierarchy = new RepositoryHierarchyCache(TimeSpan.Zero);
