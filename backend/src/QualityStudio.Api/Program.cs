...
builder.Services.AddSingleton<ArchitectureSensor>();
...
builder.Services.AddSingleton<IReviewSensor>(serviceProvider => serviceProvider.GetRequiredService<ArchitectureSensor>());
