...
public sealed class ApiSecurityOptions
{
    ...
    /// <summary>
    /// Command-backed analyzer sensors (sarif/roslyn/eslint/tsc) execute a repository-configured executable on
    /// the host. Disabled by default per docs/operations/security/index.html (S0): a client that can configure a
    /// repository's sensors must not be able to turn that into arbitrary host command execution.
    /// </summary>
