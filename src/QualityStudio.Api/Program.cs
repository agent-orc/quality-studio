    ...
    CancellationToken cancellationToken)
{
    ...
    {
        var availability = sensor is IRepositoryAwareReviewSensor repositoryAware
            ? await repositoryAware.ProbeAvailabilityAsync(registration.RootPath, cancellationToken)
