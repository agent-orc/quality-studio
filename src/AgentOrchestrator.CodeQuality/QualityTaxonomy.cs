...
/// <summary>
/// Loads and validates the embedded core quality taxonomy catalogue (quality-studio/core@1.0.0),
/// the term registry that gives review aspects, verdicts, and evidence a shared, versioned meaning.
/// </summary>
...
/// <summary>
/// One producer's immutable, pinned result for one exact subject and input set (quality-observation.v1).
/// This type is a pure contract: nothing in this slice writes it to disk yet.
/// </summary>
...
/// <summary>
/// Serializes and reads quality-observation.v1 documents. An unsupported schema or taxonomy major is
/// quarantined as structured-but-unsupported: the raw JSON is preserved and no verdict is inferred.
/// </summary>
...
/// <summary>
/// Pure adapters from every current review/security/flow/change/finding-state spelling to the
/// core v1 axes in section 8 of the data-model taxonomy dossier. These do not touch any writer.
/// </summary>
