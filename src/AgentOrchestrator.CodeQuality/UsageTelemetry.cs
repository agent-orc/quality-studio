...
public sealed record ReviewUsageEntry(
    ...
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] string? RequestedThinkingLevel = null,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] string? ExecutedThinkingLevel = null,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] string? SourceRevision = null,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] string? RequestedCliType = null);
...
public static class UsageLedger
{
    ...
    private static bool IsSupported(ReviewUsageEntry entry)
    {
        ...
        return entry.SchemaVersion switch
        {
            ...
            CurrentSchemaVersion => !string.IsNullOrWhiteSpace(entry.SourceRevision),
            _ => false,
        };
    }
