...
/// <summary>
/// Probes tool availability against a specific repository instead of the host process directory.
/// </summary>
public interface IRepositoryAwareReviewSensor : IReviewSensor
{
