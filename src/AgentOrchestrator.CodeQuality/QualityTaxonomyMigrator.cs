...
public static class QualityTaxonomyMigrator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var usage = await UsageLedger.ReadAsync(root, cancellationToken: cancellationToken).ConfigureAwait(false);
        var usageByRun = usage.GroupBy(item => item.RunId, StringComparer.Ordinal)
