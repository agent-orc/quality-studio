...
public sealed class QualityAnalysisCoreTests
{
    ...
    [Fact]
    public void Core_assembly_has_no_AspNetCore_Agent_Studio_HTTP_client_or_UI_rule_catalogue()
    {
        ...
        Assert.Null(assembly.GetType("AgentOrchestrator.CodeQuality.GuidelineCatalogueEntry"));
    }
