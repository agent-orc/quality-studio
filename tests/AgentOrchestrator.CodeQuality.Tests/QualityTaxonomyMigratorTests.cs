...
public sealed class QualityTaxonomyMigratorTests
{
    ...
    public void ChangeAdapterPreservesFourJudgementsOnTheChangeAxis()
    {
        ...
        Assert.Equal("change-set", observation.Subject.Scope);
    }
            ...
            var legacy = """
                         {
                           ...
                           "reviewedHash": { "value": "sha256:subject" },
                           "reviewInputs": {
                             "effectiveHash": { "value": "sha256:inputs" },
                             "prompt": { "id": "file-code-review", "version": "1.0.0", "contentHash": "sha256:prompt" }
                           },
