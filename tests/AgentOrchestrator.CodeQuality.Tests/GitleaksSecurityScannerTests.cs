...
public sealed class GitleaksSecurityScannerTests : IAsyncLifetime
{
    ...
    private string? _previousFakeScenario;
    private string? _previousFakeVersion;
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _previousFakeScenario = Environment.GetEnvironmentVariable("FAKE_GITLEAKS_SCENARIO");
        _previousFakeVersion = Environment.GetEnvironmentVariable("FAKE_GITLEAKS_VERSION");
    ...
    public ValueTask DisposeAsync()
    {
        ...
        Environment.SetEnvironmentVariable("FAKE_GITLEAKS_SCENARIO", _previousFakeScenario);
        Environment.SetEnvironmentVariable("FAKE_GITLEAKS_VERSION", _previousFakeVersion);
